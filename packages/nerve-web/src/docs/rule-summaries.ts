...
export const RULE_SUMMARIES: Record<string, string> = {
  ...
  multipleElectricalSources: "A net must not join multiple declared electrical sources.",
  undrivenElectricalLoad: "Only a fully role-typed net can be undriven; each sink needs a source or bidirectional driver.",
  voltageDomainMismatch: "A source output range must be wholly accepted by connected typed ports; explicitly incompatible complete ranges are rejected.",
  protocolMismatch: "Declared protocol identities must agree across an electrical net.",
  differentialSemanticConflict: "A differential pair must preserve its declared pair identity and polarity semantics.",
  sourceCurrentExceeded: "The total declared sink demand on a net must not exceed its source capacity.",
